...
HD_PWD='/home/enjon/Dropbox/01_DIPLOME/09_platforms/zybo_hdmi_light_linux/zybo_hdmi_in/vivado/zybo_hdmi_in.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log zybo_hdmi_in_wrapper.vdi -applog -m64 -messageDb vivado.pb -mode batch -source zybo_hdmi_in_wrapper.tcl -notrace
